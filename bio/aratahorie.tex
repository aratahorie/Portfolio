...
\\{\em Project Senior Assistant Professor}\hfill {\em April 2026 - present} 

{\bf Keio University Graduate School of Media Design, Embodied Media} \hfill {\bf Tokyo, Japan} 
\\{\em Project Assistant Professor}\hfill {\em April 2023 - March 2026} 
...
% \\{\em Japan Science and Technologies} \\
% \vspace{-3mm}
{\bf Audience Choice Award, SIGGRAPH 2026 Emerging Technologies}\hfill {\bf 2026}
\\{\em Co-author, "EmoMime: Augmenting Social Behavior and Self-Expression via Wearable Robotic Limbs"} \\
...
\begin{Subsection}{Journal Paper}
  \begin{enumerate}
    ...
    \item \bibentry{saito2021transparency}
  \end{enumerate}
\end{Subsection}
\begin{Subsection}{Conference Paper}
  \begin{enumerate} 
  \item \bibentry{kotani2026audiohapticdiffusion}
  \item \bibentry{kotani2026ders}
...
\begin{Subsection}{Demo}
  \begin{enumerate}  
    \item \bibentry{shimobayashi2026emomime}{ \bf SIGGRAPH 2026 Emerging Technologies Audience Choice Award}
    \item \bibentry{higashi2026experience}
...
{\bf 力覚提示装置及び力覚提示方法} \hfill {\bf 日本特許第7313079号 / 米国特許第11947725号}
\\{\em 堀江新（75/100）, 稲見昌彦（25/100）} \hfill {\em }

{\bf 力覚提示装置及び力覚提示方法} \hfill {\bf 日本特許第7627059号}
\\{\em 堀江新（75/100）, 稲見昌彦（25/100）} \hfill {\em }

{\bf 力覚提示装置、運動教示装置、力覚提示方法、運動教示方法およびプログラム} \hfill {\bf 特開2025-002797}
\\{\em 堀江新（75/100）, 稲見昌彦（25/100）} \hfill {\em }

{\bf 運動教示装置、運動教示システム、運動教示方法およびプログラム} \hfill {\bf WO2022/145258}
